...
class BirdDetector:
    def __init__(self, model_path):
        self.model = axe.InferenceSession(model_path, providers=['AxEngineExecutionProvider'])
...
class BirdClassifier:
    """Bird classification classifier based on axmodel Runtime"""
...
def main():
    parser = argparse.ArgumentParser(description="axmodel Runtime Bird Detection + Crop + Classification (Batch Mode)")
